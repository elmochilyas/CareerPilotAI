...
Manage typed profile records (education, experience, project, certification) through add, edit, delete, and reorder operations. Profile items provide the structured evidence that drives match scoring and resume generation.
