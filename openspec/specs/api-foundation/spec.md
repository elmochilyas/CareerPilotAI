...
Define the foundational API contracts, request tracing, error handling, frontend client, CI, and documentation standards that every subsequent capability builds upon.
