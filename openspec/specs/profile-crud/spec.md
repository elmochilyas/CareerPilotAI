...
Manage the authenticated candidate's master profile — headline, summary, contact links, career preferences, languages, and profile-level metadata. Every downstream feature (matching, resume, applications) depends on this capability.
